...
playerArcher = Bodies.rectangle(120,160,180,150,options);
...
image(playerArcherImg,playerArcher.position.x,playerArcher.position.y,180,150);
  ...
  image(player.position.x,player.position.y,50,180)

  image(playerBase.position.x,playerBase.position.y,180,150)

  image(playerArcher.position.x,playerArcher.position.y,180,150)
  drawSprites()
}
